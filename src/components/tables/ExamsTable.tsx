  ...
  return (
    <>
      ...
      <div className="bg-indigo-700 ring-1 ring-indigo-100 rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
        {/* Header da Tabela */}
        <div className="hidden lg:grid lg:grid-cols-6 gap-4 p-4 lg:px-5 lg:py-3 font-semibold text-sm text-white tracking-wider">
          <div className="col-span-2">Exames</div>
        ...
        <div className="divide-y divide-gray-100">
          {exams.map((exam, index) => (
            <div
              ...
              className="border-slate-200 grid grid-cols-1 lg:grid-cols-6 gap-4 p-4 lg:px-5 lg:py-3 bg-slate-50 hover:bg-slate-100 transition-all duration-300 group"
            >
